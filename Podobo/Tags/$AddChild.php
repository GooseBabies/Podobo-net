...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<?php
			...
			echo "<p>" . $tag[0] . "</p>";
			echo "<p> - </p>";
			echo "<input type='text' id='child' oninput='TagSuggestions(this.value)' />";
			echo "</div>";
			
			echo "<hr />";

			echo "<div class='w3-center'>";
				echo "<input class='w3-center' id='submitbutton' type='button' value='Submit' onclick='SubmitChild()'/>";	
			echo "</div>";
	...
	<script type="text/javascript">
		...
		{
			input = document.getElementById("child");
			input.value = "";
			...
			input.addEventListener("awesomeplete-select", (event) => {
		...
		function SubmitChild()
		{
			...
			var childtag = input.value;
			
			$.ajax({
				url: 'AddChildAjax.php?tagid=' + tagid + '&child=' + childtag,
				type: 'get',
				dataType: 'JSON',
				success: function(response){
