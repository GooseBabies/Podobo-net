...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<?php
			...
			echo "<p>" . $tag[0] . "</p>";
			echo "<p> - </p>";
			echo "<input type='text' id='parent' oninput='TagSuggestions(this.value)' />";
			//echo "</div>";
			//echo "<div class='w3-center'>";
			...
			echo "<div class='w3-center'>";
				echo "<input class='w3-center' id='submitbutton' type='button' value='Submit' onclick='SubmitParent()'/>";	
			echo "</div>";
	...
	<script type="text/javascript">
		...
		function SubmitParent()
		{
			...
			var parenttag = input.value;
			var category = categories.value;
			
			$.ajax({
				url: 'AddParentAjax.php?tagid=' + tagid + '&parent=' + parenttag + '&cat=' + category,
				type: 'get',
				dataType: 'JSON',
				success: function(response){
