...
?>
			...
			{
				echo "<div><video class='center-fit' loop controls muted src='" . strtolower(substr(pathinfo($file_item, PATHINFO_DIRNAME), 3)) . "\\"  . rawurlencode(basename($file_item)) . "' poster='thumbs/" . pathinfo(rawurlencode(basename($file_item)), PATHINFO_FILENAME) . ".jpg'></video>";
				//echo "<p text-align'center'>" . basename($file_item) . "</p></div>";
			}	
