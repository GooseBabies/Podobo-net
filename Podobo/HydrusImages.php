    ...
    echo "<div class='col-10'><div id='resdiv' class='posts-wrapper'>";	
		...
		<script type="text/javascript">
			$(document).ready(function()
			{
                ...
                $.ajax({
					url: 'https://podobo.ddns.net:45869/get_files/search_files?file_sort_type=6&file_sort_asc=false&tags=%5B%5B%22' + <?php echo ($namespace != '' ? json_encode(str_replace("_", "%20", $namespace) . '%3A') . "+" : ''); echo json_encode(str_replace("_", "%20", $tag)); ?> + '%22,%22' + <?php echo ($namespace != '' ? json_encode($namespace . '%3A') . "+" : ''); echo json_encode($tag); ?> + '%22%5D%2C%20%22system%3Alimit%3D98%22%5D&Hydrus-Client-API-Access-Key=832e84084dab1249084d5f7fc1823ab6e58851c992e733133d4b68d3693492b9',
					type: 'get',
                    crossDomain: true,
					dataType: 'JSON',
            ...
            function displayFunction(id){
                ...
                resdiv.innerHTML += "<article class='post-article'><div class='post-preview'><a href='HydrusPost.php?id=" + id + "'><img class='hydrus-thumbs' src='https://podobo.ddns.net:45869/get_files/thumbnail?file_id=" + id + "&Hydrus-Client-API-Access-Key=832e84084dab1249084d5f7fc1823ab6e58851c992e733133d4b68d3693492b9' /></a></div></article>";
            }
		</script>
	</body>
</html>
