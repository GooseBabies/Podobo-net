...
?>
	...
	<script>
		$(document).ready(function()
		{
			...
			$.ajax({
                    url: 'https://podobo.ddns.net:45869/get_files/file_metadata?file_ids=%5B' + <?php echo $id; ?> + '%5D',
					type: 'get',
                    headers: {"Hydrus-Client-API-Access-Key" : "832e84084dab1249084d5f7fc1823ab6e58851c992e733133d4b68d3693492b9"},
					dataType: 'JSON',
					success: function(response){	
                        //console.log(response.metadata[0].tags["616c6c206b6e6f776e2074616773"].display_tags[0]);
                        console.log(response.metadata[0]);			
						for (let i = 0; i < response.metadata[0].tags["616c6c206b6e6f776e2074616773"].display_tags[0].length; i++) {
                            DisplayTags(response.metadata[0].tags["616c6c206b6e6f776e2074616773"].display_tags[0][i]);
                        }
        ...
        function DisplayImage(){
            mediaarea.innerHTML = "<img class='center-fit' src='https://podobo.ddns.net:45869/get_files/file?file_id=<?php echo $id; ?>&Hydrus-Client-API-Access-Key=832e84084dab1249084d5f7fc1823ab6e58851c992e733133d4b68d3693492b9' />";
        }

        function DisplayVideo(){
            mediaarea.innerHTML = "<video class='center-fit' loop controls src='https://podobo.ddns.net:45869/get_files/file?file_id=<?php echo $id; ?>&Hydrus-Client-API-Access-Key=832e84084dab1249084d5f7fc1823ab6e58851c992e733133d4b68d3693492b9'></video>";
        }
