...
?>
	...
	<body>
			...
			<div id="subheader" class="w3-bar w3-theme-l1 w3-left-align w3-small container_subheader">	
                <a id="main" class="w3-bar-item w3-button w3-theme-l1" href="Main.php">Main</a>
                <a id="shop" class="w3-bar-item w3-button w3-theme-l1" href="Shop.php">Shop</a>
                <a id="inventory" class="w3-bar-item w3-button w3-theme-l1" href="Inventory.php">Inventory</a>
                <a id="rewards" class="w3-bar-item w3-button w3-theme-l1" href="Rewards.php">Rewards</a>
                <a id="player" class="w3-bar-item w3-button w3-theme-l1" href="Player.php">Player</a>  
                <a id="gacha" class="w3-bar-item w3-button w3-theme-l1" href="Gacha.php">Gacha</a>                     
            </div>
