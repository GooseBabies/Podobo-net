...
?>
	...
	<body>
			...
			<div id="subheader" class="w3-bar w3-theme-l1 w3-left-align w3-small container_subheader">	
                <a id="random" class="w3-bar-item w3-button w3-theme-l1" href="<?= isset($InTags) ? "../" : ""?>Post.php?id=<?php echo $files[$r]; ?>">Random</a>
				...
				<a id="lavapool" class="w3-bar-item w3-button w3-theme-l1" href="<?= isset($InTags) ? "../" : ""?>LavaIntro.php">LavaPool</a>
